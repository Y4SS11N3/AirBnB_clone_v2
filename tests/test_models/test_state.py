#!/usr/bin/python3
"""Outlines unittests for models/state.py"""
import os
import models
import MySQLdb
import unittest
...
class TestState(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Setup for State tests includes renaming file.json temporarily,
    ...
    def test_is_subclass(self):
        """Confirms State is derived from BaseModel."""
    ...
    def test_two_models_are_unique(self):
        """Asserts uniqueness of State instances."""
        st = State()
