#!/usr/bin/python3
"""Outlines unnittests for models/place.py"""
import os
import models
import MySQLdb
import unittest
...
class TestPlace(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Setup for Place tests includes renaming file.json temporarily,
    ...
    def test_is_subclass(self):
        """Confirms Place is derived from BaseModel."""
    ...
    def test_two_models_are_unique(self):
        """Asserts uniqueness of Place instances."""
        us = Place()
