#!/usr/bin/python3
"""Outlines unnittests for models/city.py"""
import os
import models
import MySQLdb
import unittest
...
class TestCity(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Setup for City tests includes renaming file.json temporarily,
    ...
    def test_is_subclass(self):
        """Confirms City is derived from BaseModel."""
    ...
    def test_two_models_are_unique(self):
        """Asserts uniqueness of City instances."""
        ct = City()
