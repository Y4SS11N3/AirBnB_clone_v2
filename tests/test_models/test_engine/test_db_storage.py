#!/usr/bin/python3
"""Outlines unnittests for models/engine/db_storage.py"""
import models
import MySQLdb
import unittest
...
class TestDBStorage(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Set up DBStorage testing by creating
        and filling it with class instances.
        """
    ...
    def tearDownClass(cls):
        """Tear down DBStorage testing by deleting
        test instances and clearing the session."""
        if type(models.storage) == DBStorage:
