#!/usr/bin/python3
"""Outlines unnittests for models/engine/file_storage.py"""
import os
import json
import unittest
...
class TestFileStorage(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Setup for FileStorage tests includes renaming file.json temporarily,
        resetting FileStorage's dictionary, and creating instances for testing.
        """
        try:
    ...
    def test_reload_no_file(self):
        """Test reload meth with no existing file.json"""
        try:
            self.storage.reload()
        except Exception:
            self.fail
    ...
    def test_delete_nonexistant(self):
        """Test delete meth with a nonexistent object"""
        try:
