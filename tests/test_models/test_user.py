#!/usr/bin/python3
"""Outlines unittests for models/user.py"""
import os
import models
import MySQLdb
import unittest
...
class TestUser(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Setup for User tests includes renaming file.json temporarily,
    ...
    def test_is_subclass(self):
        """Confirms User is derived from BaseModel."""
    ...
    def test_two_models_are_unique(self):
        """Asserts uniqueness of User instances."""
        us = User(email="a", password="a")
    ...
    def test_save_filestorage(self):
        """Tests saving functionality with FileStorage and DBStorage."""
